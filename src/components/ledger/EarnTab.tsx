  ...
  return (
    <div className="relative pb-32">
      ...
      <div className="relative">
        ...
        <h1 className="mt-14 px-6 text-center text-[46px] font-medium leading-[1.05] tracking-tight">
          Make your assets
          <br />
          earn for you
        </h1>
        ...
        <div className="mt-7 flex justify-center">
          <button
            ...
            className="rounded-full bg-foreground px-9 py-4 text-[19px] font-medium text-background active:scale-[0.98]"
          >
        ...
        <div className="mt-9 flex items-center gap-2 px-5">
          <h2 className="text-[26px] font-medium tracking-tight">Crowd favorites</h2>
        ...
        <h2 className="mt-8 px-5 text-[26px] font-medium tracking-tight">Top stablecoins</h2>
        ...
        >
          ...
          <span className="flex-1 text-[19px] font-medium">Simulate rewards</span>
          <ChevronRight className="h-5 w-5 text-muted-foreground" />
        </button>

        <h2 className="mt-8 px-5 text-[26px] font-medium tracking-tight">How does it work?</h2>
        <div className="mt-3 space-y-2 px-5">
          {[
            ...
            <div key={t} className="flex gap-4 rounded-2xl bg-card p-4">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-secondary text-[15px] font-medium">
                {i + 1}
              </span>
              <div>
                <p className="text-[17px] font-medium">{t}</p>
    ...
    <div className="mt-3 flex gap-3 overflow-x-auto px-5 pb-1 [scrollbar-width:none]">
      {items.map((a) => (
        ...
        >
          ...
          <p className="w-full truncate text-center text-[17px] font-medium">{a.name}</p>
